...
st.title("OTT Sentiment Analyzer")

# Input teks untuk prediksi
user_input = st.text_input("Masukkan Ulasan Pengguna:")
...
if st.button("Predict CSV") and uploaded_file is not None:
    ...
    # Memeriksa apakah DataFrame memiliki kolom 'content'
    if 'content' not in df.columns:
        st.error("File CSV harus memiliki kolom 'content'.")
    else:
